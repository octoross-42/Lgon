    ...
    for (const role of bot.roles.values()) {
        ...
        if (roleCategory != role.getMainCategory()) {
            if (roleCategory !== null)
                embed.addFields({ name: roleCategory,
                    value: rolesContent,
                    inline: true });
...
export async function help_role(message, role) {
}
export async function help_command(message, command) {
