...
import { L, L_RED, L_BLACK, L_RESET, L_BGBLACK, L_BGBLUE, L_BGBLUEPURPLE, L_BGBROWN, L_BGCYAN, L_BGGREEN, L_BGGREY, L_BGLBLUE, L_BGLGREEN, L_BGLGREY, L_BGORANGE, L_BGPURPLE, L_BGRED, L_BGROSE, L_BGWHITE, L_BGYELLOW, L_BLUE, L_BLUEPURPLE, L_BROWN, L_CYAN, L_GREEN, L_GREY, L_LBLUE, L_LGREEN, L_LGREY, L_ORANGE, L_PURPLE, L_ROSE, L_WHITE, L_YELLOW } from "./infra/LOG_FORMAT.js";
function test_log() {
...
export async function bootstrap() {
    ...
    const bot = await initDiscordClient(new DiscordMessagingCache(), logger);
    const roles = await loadRoles();
    console.log(roles);
    const userStore = new UserStore(logger);
    const gameStore = new GameStore(roles, logger);
    const flowRunner = new FlowRunner(bot.messenger, gameStore, userStore, logger);
    const lgon = new LgonContext(roles, gameStore, userStore, flowRunner, logger);
