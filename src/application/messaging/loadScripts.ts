import type { ScriptMaker } from "./model/Script.js";
...
export type ScriptName = "LobbyControls" |
						"LobbyPlayers" |
						"LobbyRoles" |
						"LobbyPresetRoles" |
						"SwitchGame" |
...
export function loadScripts(gameStore: GameStore, userStore: UserStore, logger: Logger): Record<ScriptName, ScriptMaker> 
{
	return ({
